...
export default {
    ...
    computed: {
        totalPrice() {
            return this.total * this.productDetail.product_price;
        },
    },
    created() {
        this.productId = this.$route.query.product_id;
        axios
            .post("/api/productDetail", { param: [this.productId] })
            .then((result) => {
        ...
        axios.post("api/productMainImage", { param: [this.productId] }).then((result) => {
